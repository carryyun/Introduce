...
console.log(${sessionScope.curUser});
//Ver.5
...
function addListItemAll(coinName, num){
	...
	let span=$('#coinListAll #coinAll'+ num +' .marketName');
	span.html(coinName);
}
...
function coinClick(item){
	...
	tableCoinName=$('#coinList #'+item.id+" .marketName").html()
	curItem=item.id;
...
function setUpbitData(coinName){
    ...
    let tmpCoin=new coin(coinName,0,0,0);
