<%@page import="com.yun.board.domain.Mentee"%>
<%@page import="com.yun.board.domain.Mentor"%>
<%@page import="com.yun.board.domain.Cert"%>
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-lg-12" style="padding: 0">
                <jsp:include page="/app/mypage/headerMainMy"></jsp:include>
                <jsp:include page="/app/mypage/headerNavMy"></jsp:include>
            </div>
